...
class Bootstrap
{
    public static void Main()
    {
        ...
        // ---
        Giardino g2 = new();
        g2.AggiungiSiepePrato(new FiguraGeometrica[] { new Cerchio(2), new Cerchio(2), new Rettangolo(6, 7), new Rettangolo(6, 7) });
        ...
        // ---
        Giardino g3 = new();
        g3.AggiungiSiepePrato(new FiguraGeometrica[] { new Rettangolo(5, 20), new Quadrato(20) });
