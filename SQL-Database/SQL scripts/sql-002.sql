...
-- Ritorna il numero delle occorrenze della colonna con valore diverso da NULL
...
-- A differenza di C# che converte tutto in string, SQL farebbe la somma tra 123 e id
SELECT 123 + id FROM regioni;
-- SQL infatti dà errore: Conversion failed when converting the varchar value 'Piemonte' to data type int.
SELECT nome + 123 FROM regioni;
